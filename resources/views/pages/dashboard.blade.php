        ...
        <div class="bg-light lter b-b wrapper-md">
          <div class="row">
            <div class="col-sm-6 col-xs-12">
              ...
              <small class="text-muted">Welcome to KAISA CAR application</small>
            </div>
            <div class="col-sm-6 text-right hidden-xs">
              <div class="inline m-r text-left">
                <div class="m-b-xs">117 <span class="text-muted">Total New CARs</span></div>
              ...
              <div class="inline text-left">
                <div class="m-b-xs">419 <span class="text-muted">Total Processing CARs</span></div>
          ...
          <div class="row">
              ...
              <div class="row row-sm text-center">
                <div class="col-xs-6">
                  <a href class="block panel padder-v bg-info item">
                    ...
                    <span class="text-muted text-xs">New CARs</span>
                    <span class="top">
                ...
                <div class="col-xs-6">
                  <a href class="block panel padder-v bg-primary item">
                    <span class="text-white font-thin h1 block">20</span>
                    <span class="text-muted text-xs">Processing CARs</span>
                ...
                <div class="col-xs-6">
                  <div class="panel padder-v item">
                    <div class="h1 text-info font-thin h1">31</div>
                    <span class="text-muted text-xs">Management Approval</span>
                ...
                <div class="col-xs-6">
                  <div class="panel padder-v item">
                    ...
                    <span class="text-muted text-xs">Closed CARs</span>
                    <div class="bottom">
                      <i class="fa fa-caret-up text-warning m-l-sm m-r-sm"></i>
                    </div>
                  </div>
            ...
            <div class="col-md-7">
              <div class="panel wrapper">
                ...
                <h4 class="font-thin m-t-none m-b text-muted">CARs Statistics</h4>
                <div ui-jq="plot" ui-refresh="showSpline" ui-options="
                  [
                    { data: [ [0,7],[1,6.5],[2,12.5],[3,7],[4,9],[5,6],[6,11],[7,6.5],[8,8],[9,7] ], label:'New CARs', points: { show: true, radius: 1}, splines: { show: true, tension: 0.4, lineWidth: 1, fill: 0.8 } },
                    { data: [ [0,4],[1,4.5],[2,7],[3,4.5],[4,3],[5,3.5],[6,6],[7,3],[8,4],[9,3] ], label:'Processing CARs', points: { show: true, radius: 1}, splines: { show: true, tension: 0.4, lineWidth: 1, fill: 0.8 } }
                  ],
                  {
          ...
          <div class="panel wrapper">
            <div class="row">
              <div class="col-md-12 {{--b-r--}} b-light no-border-xs">
                ...
                <h4 class="font-thin m-t-none m-b-md text-muted">Most Recent CARs</h4>
                <div class=" m-b">
                  <div class="m-b">
                    <span class="label text-base bg-warning pos-rlt m-r"><i class="arrow right arrow-warning"></i> Feb 23 2018 19:30</span>
                    <a href>Seamlessly coordinate distributed supply chains vis-a-vis intermandated customer service. Proactively maintain cross functional ideas after maintainable content.</a>
                  </div>
                  <div class="m-b">
                    <span class="label text-base bg-info pos-rlt m-r"><i class="arrow right arrow-info"></i> Feb 19 2018 12:30</span>
                    <a href>Rapidiously pursue cross functional applications through extensible action items. </a>
                  </div>
                  <div class="m-b">
                    <span class="label text-base bg-primary pos-rlt m-r"><i class="arrow right arrow-primary"></i> Feb 13 2018 10:30</span>
                    <a href>Globally network best-of-breed products rather than integrated content. </a>
                  </div>
                  <div class="m-b">
                    <span class="label text-base bg-light pos-rlt m-r"><i class="arrow right arrow-light"></i> Feb 10 2018 07:30</span>
                    <a href>Seamlessly disintermediate adaptive e-tailers via future-proof interfaces. </a>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="panel no-border">
                <div class="panel-heading wrapper b-b b-light">
                  ...
                  <h4 class="font-thin m-t-none m-b-none text-muted">New Conversations</h4>
                </div>
                <ul class="list-group list-group-lg m-b-none">
                  <li class="list-group-item">
                    ...
                    <span class="pull-right label bg-primary inline m-t-sm">CAR #12</span>
                    <a href>Damon Parker</a>
                    <small class="text-muted clear text-ellipsis" style="margin-top:
10px;">Authoritatively grow clicks-and-mortar methods of empowerment after progressive networks. Holisticly synthesize prospective channels after adaptive bandwidth. Dramatically implement functional services before seamless initiatives. Holisticly leverage other's cross-platform experiences rather than front-end opportunities. Compellingly transition enterprise convergence for accurate services.</small>
                  </li>
                  <li class="list-group-item">
                    <a href class="thumb-sm m-r">
                      <img src="img/a2.jpg" class="r r-2x">
                    </a>
                    <span class="pull-right label bg-primary inline m-t-sm">CAR #11</span>
                    <a href>Damon Parker</a>
                    <small class="text-muted clear text-ellipsis" style="margin-top:
10px;">Authoritatively grow clicks-and-mortar methods of empowerment after progressive networks. Holisticly synthesize prospective channels after adaptive bandwidth. Dramatically implement functional services before seamless initiatives. Holisticly leverage other's cross-platform experiences rather than front-end opportunities. Compellingly transition enterprise convergence for accurate services.</small>
                  </li>
                  <li class="list-group-item">
                    ...
                    <span class="pull-right label bg-primary inline m-t-sm">CAR #10</span>
                    <a href>Damon Parker</a>
                    <small class="text-muted clear text-ellipsis" style="margin-top:
10px;">Authoritatively grow clicks-and-mortar methods of empowerment after progressive networks. Holisticly synthesize prospective channels after adaptive bandwidth. Dramatically implement functional services before seamless initiatives. Holisticly leverage other's cross-platform experiences rather than front-end opportunities. Compellingly transition enterprise convergence for accurate services.</small>
                  </li>
                  <li class="list-group-item">
                    ...
                    <span class="pull-right label bg-primary inline m-t-sm">CAR #9</span>
                    <a href>Damon Parker</a>
                    <small class="text-muted clear text-ellipsis" style="margin-top:
10px;">Authoritatively grow clicks-and-mortar methods of empowerment after progressive networks. Holisticly synthesize prospective channels after adaptive bandwidth. Dramatically implement functional services before seamless initiatives. Holisticly leverage other's cross-platform experiences rather than front-end opportunities. Compellingly transition enterprise convergence for accurate services.</small>
                  </li>

...
# Generation Time: 2018-02-20 09:14:29 +0000
# ************************************************************
...
VALUES
	...
	(3,1,7,5,1,NULL,'Enthusiastically fashion team driven processes and integrated catalysts for change. Professionally administrate timely value after long-term high-impact outsourcing. Assertively target extensive e-business without client-based information.','2018-02-15 03:33:20','2018-02-15 03:33:20',NULL);
...
INSERT INTO `messages` (`id`, `parent_id`, `car_id`, `user_id`, `status_id`, `message`, `created_at`, `updated_at`)
VALUES
	(1,0,1,7,1,'Conveniently synergize leading-edge services whereas granular products. Professionally morph scalable architectures with low-risk high-yield meta-services.','2018-02-19 10:22:33','2018-02-19 10:22:33'),
	(2,0,1,1,1,'Monotonectally iterate client-focused value after innovative markets. Synergistically incentivize cross-unit intellectual capital rather than ubiquitous expertise. Distinctively myocardinate out-of-the-box deliverables through functionalized manufactured products. Uniquely empower top-line leadership rather.',NULL,NULL);
...
VALUES
	...
	(271,'2018_02_19_021409_create_messages_table',2);
...
INSERT INTO `notifiables` (`notification_id`, `notifiable_id`, `notifiable_type`, `car_id`, `seen`, `created_at`, `updated_at`)
VALUES
	(1,7,'App\\User',1,0,NULL,NULL),
	(1,5,'App\\User',1,0,NULL,NULL),
	(1,7,'App\\User',3,0,NULL,NULL);
...
VALUES
	(1,'Regie','','Ebalobor','reg.ebalobor@kaisa.com','$2y$10$sPZ5tzhHhu70v1hXW7lIpO0dtKrCPdjs6HBaJ5r45XPR9SNqihB9O','ygV0H8fF50GRDoQZswvyEHRGxWt2ktYRm0W5aRfPQCt4ym6co5WsQDKgJTM1',NULL,NULL),
	...
	(7,'Jeff','','Turla','jeff.turla@kaisa.com','$2y$10$LDcJ46pyO4iMQiV60U4f/u2JlGk4N2UENWPNAhnqk24LNombNVU62','K8NFBGSiWaoqiHmIIqKcAIfWO58jkUsfh1VuBwR04xE6AYArMQjEY7LyNOnV',NULL,NULL);

...
# Generation Time: 2018-02-12 01:29:39 +0000
# ************************************************************
...
VALUES
	(1,'Clasification A','2018-02-09 14:54:06','2018-02-09 14:54:06'),
	(2,'Clasification B','2018-02-09 14:54:06','2018-02-09 14:54:06'),
	(3,'Clasification C','2018-02-09 14:54:06','2018-02-09 14:54:06'),
	(4,'Clasification D','2018-02-09 14:54:06','2018-02-09 14:54:06');
...
VALUES
	...
	(6,'2018_02_08_062342_create_car_status_table',2),
...
CREATE TABLE `users` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `first_name` varchar(198) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `last_name` varchar(198) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
VALUES
	(1,'Regie','Ebalobor','reg.ebalobor@kaisa.com','$2y$10$jnhUPB1L.gqLCgRvReYyV.YDwhdMUbwJ/QAVGcxmG1dnkD3uWvCRe','96uGLNRHXLiuX6zuZPnCiVzsVJOj0j9foWT8GCslReb6lA88YP2rrNYLwXc3','2018-02-05 03:08:22','2018-02-05 03:08:22'),
	(3,'Viktor',NULL,'tor.dimalanta@kaisa.com','$2y$10$Zjkj0KVS2y/niOs4N7JXVeIIGzC2R/k3sf5PsUDUy1lgpgFNz4Lsy',NULL,'2018-02-05 03:08:22','2018-02-05 03:08:22'),
	(4,'Juan Domingo',NULL,'jd.rivera@kaisa.com','$2y$10$aDT8gKAF/vIlWkVyOFadFuPAPsbK8hklP9CUEhOxmmFiN2Nijfug6',NULL,'2018-02-05 03:08:22','2018-02-05 03:08:22'),
	(5,'Tin',NULL,'kristine.durante@kaisa.com','$2y$10$B0yx0hSVlLGWSfOf/kiluOoXTBqnK/WRfEpoM74e6xjIhNRouZajq',NULL,'2018-02-05 03:08:22','2018-02-05 03:08:22'),
	(6,'Jonar',NULL,'jonar.gregorio@kaisa.com','$2y$10$B0yx0hSVlLGWSfOf/kiluOoXTBqnK/WRfEpoM74e6xjIhNRouZajq',NULL,'2018-02-08 17:18:19','2018-02-08 17:18:22');
